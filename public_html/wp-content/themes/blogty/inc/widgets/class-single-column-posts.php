...
class Blogty_Single_Column_Posts extends Blogty_Widget_Base {
	/**
	 * Constructor.
	 */
	public function __construct() {

		$this->widget_cssclass    = 'blogty_single_column_posts_widget';
		$this->widget_description = __( 'Displays posts in single column style', 'blogty' );
		$this->widget_id          = 'blogty_single_column_posts';
		$this->widget_name        = __( 'Blogty: Single Column Posts', 'blogty' );
		$this->settings           = array(
			'title'                     => array(
				'type'  => 'text',
	...
	public function get_posts( $args, $instance ) {
		...
		return new WP_Query( apply_filters( 'blogty_single_column_posts_query_args', $query_args ) );
	}
	...
	public function widget( $args, $instance ) {
		...
		if ( ( $posts = $this->get_posts( $args, $instance ) ) && $posts->have_posts() ) {
			...
			do_action( 'blogty_before_single_column_posts' );
			...
			<div class="blogty-single-col-posts-widget <?php echo esc_attr( $widget_class ); ?>">
			...
			do_action( 'blogty_after_single_column_posts' );
