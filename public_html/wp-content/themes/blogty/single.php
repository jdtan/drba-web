...
// Post Style.
$single_post_style = get_post_meta( $post->ID, 'blogty_single_post_style', true );
...
// Enabled Post Meta.
$enabled_post_meta = blogty_get_single_post_metas( $post->ID );
...
if ( '0' == $center_align_header_meta ) {
	...
	$center_align_header_meta = get_theme_mod( 'center_align_single_header_meta' );
}
		...
		<div class="primary-content-area-wrapper">
			...
			while ( have_posts() ) :
				...
				if ( 'post' === get_post_type() ) :
					...
					$show_author_info   = blogty_show_author_info( get_the_ID() );
					$show_author_posts  = blogty_show_author_posts( get_the_ID() );
				...
				if ( 'post' === get_post_type() ) :
					...
					$show_related_posts = blogty_show_related_posts( get_the_ID() );
