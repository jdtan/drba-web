...
<header id="masthead" class="site-header-row-wrapper site-header blogty-site-header<?php echo esc_attr( $header_class ); ?>" role="banner" <?php echo $bg_attr; ?>>
	<div class="blogty-site-branding-row">
		<div class="uf-wrapper">
			<div class="blogty-site-brand-ad-wrapper<?php echo esc_attr( $wrapper_class ); ?>">
