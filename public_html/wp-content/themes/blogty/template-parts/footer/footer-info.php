...
if ( $enable_copyright || $enable_footer_credit || $enable_footer_nav || $enable_footer_social_nav ) :
	if ( get_theme_mod( 'enable_border_above_sub_footer', true ) ) {
		$border_class .= ' saga-item-border-top';
	}
	// Inverted Footer.
	if ( 'dark' == get_theme_mod( 'sub_footer_theme', 'light' ) ) {
		$wrapper_classes .= ' inverted-sub-footer';
	}
	?>
	<div class="site-sub-footer<?php echo esc_attr( $wrapper_classes ); ?>">
		<div class="uf-wrapper">
			<div class="blogty-footer-siteinfo<?php echo esc_attr( $border_class ); ?>">
					...
					<div class="footer-credits">
						...
						<?php if ( $enable_copyright ) : ?>
							<div class="footer-copyright">
								<?php
								$copyright_text = get_theme_mod( 'copyright_text', esc_html__( 'Copyright &copy; {{ date }}', 'blogty' ) );
								if ( $copyright_text ) :
						...
						<?php if ( $enable_footer_credit ) : ?>
							<div class="theme-credit">
								<?php printf( esc_html__( '&nbsp;- Powered by %1$s.', 'blogty' ), '<a href="https://unfoldwp.com/products/blogty" target = "_blank" rel="designer">Blogty</a>' ); ?>
							</div>
					...
					<div class="site-footer-menu footer-nav-menu">
						...
						wp_nav_menu(
							array(
								...
								'fallback_cb'     => false,
								'depth'           => 1,
								'menu_class'      => 'blogty-footer-menu reset-list-style',
							)
						);
						?>
					</div>
