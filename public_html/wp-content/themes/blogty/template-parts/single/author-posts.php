...
$author_posts_text = get_theme_mod( 'author_posts_text', __( 'More From Author', 'blogty' ) );
...
if ( $author_posts_query->have_posts() ) :
	...
	$author_post_meta                  = get_theme_mod( 'author_post_meta', array( 'date' ) );
	$author_post_meta_settings         = array(
		...
		'show_icons'   => get_theme_mod( 'show_author_post_meta_icon', true ),
	);
	...
	<div class="blogty-author-posts-wrapper blogty-post-extras-grid-block wide-max-width">
		...
		if ( $author_posts_text ) :
			$title_style = get_theme_mod( 'author_posts_title_style', 'style_1' );
				...
				<div class="blogty-article-block-wrapper img-animate-zoom blogty-card-box">
					...
					<div class="article-details">
						...
						if ( $show_author_posts_category ) :
							...
							blogty_post_categories( $author_posts_category_style, $author_posts_category_color_display, $author_posts_category_limit );
							echo '</div>';
						endif;
						?>
						...
						<?php blogty_post_meta_info( $author_post_meta, $author_post_meta_settings ); ?>
						<?php
