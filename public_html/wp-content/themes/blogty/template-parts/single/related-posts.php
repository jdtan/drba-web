...
$related_posts_text = get_theme_mod( 'related_posts_text', __( 'You May Also Like', 'blogty' ) );
...
if ( ! empty( $category_ids ) ) :
	...
	if ( $related_posts_query->have_posts() ) :
		...
		$related_post_meta_settings         = array(
			...
			'show_icons'   => get_theme_mod( 'show_related_post_meta_icon', true ),
		);
					...
					<div class="blogty-article-block-wrapper img-animate-zoom blogty-card-box">
						...
						<div class="article-details">
							...
							if ( $show_related_posts_category ) :
								...
								blogty_post_categories( $related_posts_category_style, $related_posts_category_color_display, $related_posts_category_limit );
								echo '</div>';
							endif;
							?>
							...
							<?php blogty_post_meta_info( $related_post_meta, $related_post_meta_settings ); ?>
							<?php
