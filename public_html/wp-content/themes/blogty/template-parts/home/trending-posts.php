...
if ( $trending_post->have_posts() ) :
	...
	if ( $arrows ) :
		...
		$block_class              .= ' blogty-swiper-outer-arrows';
	endif;
	...
	if ( $dots ) :
		...
		$wrapper_class .= ' blogty-slider-pagination-enabled';
		$block_class   .= ' blogty-swiper-outer-bullets';
	endif;
	...
	$wrapper_class .= ' ' . get_theme_mod( 'trending_posts_style', 'style_1' );
	?>
	<section class="blogty-section-block section-trending <?php echo esc_attr( $wrapper_class ); ?>">
		<div class="uf-wrapper">
			...
			<div class="saga-section-content">
				<div class="blogty-slider-wrapper-block as_carousel <?php echo esc_attr( $block_class ); ?>">
										...
										<div class="blogty-article-block-wrapper img-animate-zoom">
											...
											<div class="article-details">
												...
												<h3 class="article-title no-margin blogty-limit-lines <?php echo esc_attr( $title_limit ); ?>">
													<a href="<?php the_permalink(); ?>" class="text-decoration-none color-accent-hover blogty-title-line">
														<?php the_title(); ?>
													</a>
												</h3>
