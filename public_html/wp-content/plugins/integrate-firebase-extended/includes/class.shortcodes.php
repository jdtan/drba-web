<?php
  class Firebase_Shortcode {
    ...
    public static function init_hooks() {
      ...
      //  Custom
      add_shortcode('firestore_pagination', array( 'Firebase_Shortcode', 'firestore_pagination_func' ));
      add_shortcode('firestore_collection', array( 'Firebase_Shortcode', 'firestore_collection_func' ));
    ...
    public static function firestore_pagination_func($atts) {
      // $class_name = "";
      // if(isset($atts['class'])){
      //   $class_name = $atts['class'];
      // }
      ...
      // return $html;
      $html = "";
      $html .= "<div id='firebase-user'>here</div>";
      return $html;
    }

    public static function firestore_collection_func($atts) {
      $html = "";
      $html .= "<div id='firebase-collection'></div>";
      return $html;
    }
